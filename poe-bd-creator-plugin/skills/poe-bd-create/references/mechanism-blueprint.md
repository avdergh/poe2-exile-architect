...
Call `validate_generation_blueprint` with the candidate ID, current version context, final
...
Do not begin PoB mutations, passive allocation, unique evaluation, `plan_gear`, crafting or item
